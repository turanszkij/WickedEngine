...
void TestsRenderer::RunFontTest()
{
	...
	font_outline.params.color = wiColor::White();
	...
	font_outline.params.posY = font_colored.params.posY + font_colored.textHeight();
	font_outline.params.outlineColor = wiColor::Red();
	font_outline.SetText("White text, red outline");
