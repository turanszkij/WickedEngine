...
#ifdef TRANSPARENT
#define load_entitytile(tileIndex, cameraIndex) (bindless_structured_uint[descriptor_index(GetCameraIndexed(cameraIndex).buffer_entitytiles_index)][GetCameraIndexed(cameraIndex).entity_culling_tile_offset + GetCameraIndexed(cameraIndex).entity_culling_tile_bucket_count_flat + tileIndex])
#else
#define load_entitytile(tileIndex, cameraIndex) (bindless_structured_uint[descriptor_index(GetCameraIndexed(cameraIndex).buffer_entitytiles_index)][GetCameraIndexed(cameraIndex).entity_culling_tile_offset + tileIndex])
#endif // TRANSPARENT
