...
static const float2 resolveSpatialSizeMinMax = float2(2.0, 16.0); // Good to have a min size as downsample scale (2x in this case)
static const uint resolveSpatialReconstructionCount = 16.0f;
