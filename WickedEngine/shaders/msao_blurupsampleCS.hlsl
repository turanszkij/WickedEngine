...
{
    float4 AO1 = LoResAO1.Gather(sampler_linear_clamp, uv);

#ifdef COMBINE_LOWER_RESOLUTIONS
    AO1 = min(AO1, LoResAO2.Gather(sampler_linear_clamp, uv));
#endif
    ...
    float4 ID = 1.0 / LoResDB.Gather(sampler_linear_clamp, uv);
