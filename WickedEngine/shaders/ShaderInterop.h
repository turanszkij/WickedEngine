...
#define CBSLOT_RENDERER_FORWARD_LIGHTMASK		3
#define CBSLOT_RENDERER_VOLUMELIGHT				3
#define CBSLOT_RENDERER_VOXELIZER				3
#define CBSLOT_RENDERER_TRACED					3
#define CBSLOT_RENDERER_BVH						3
#define CBSLOT_RENDERER_CUBEMAPRENDER			4

#define CBSLOT_OTHER_EMITTEDPARTICLE			3
#define CBSLOT_OTHER_HAIRPARTICLE				3
