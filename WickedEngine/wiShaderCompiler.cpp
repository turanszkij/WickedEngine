		...
		if (pShader != nullptr)
		{
			...
			*internal_state = pShader;
			...
			if (input.format == ShaderFormat::METAL)
			{
				...
				{
					LINK_DLL_FUNCTION(IRCompilerCreate, irconverter)
					LINK_DLL_FUNCTION(IRCompilerSetMinimumGPUFamily, irconverter)
					LINK_DLL_FUNCTION(IRCompilerSetCompatibilityFlags, irconverter)
					LINK_DLL_FUNCTION(IRCompilerSetValidationFlags, irconverter)
					LINK_DLL_FUNCTION(IRCompilerSetEntryPointName, irconverter)
					LINK_DLL_FUNCTION(IRCompilerSetStageInGenerationMode, irconverter)
					LINK_DLL_FUNCTION(IRObjectCreateFromDXIL, irconverter)
					LINK_DLL_FUNCTION(IRCompilerAllocCompileAndLink, irconverter)
					LINK_DLL_FUNCTION(IRErrorDestroy, irconverter)
					LINK_DLL_FUNCTION(IRMetalLibBinaryCreate, irconverter)
					LINK_DLL_FUNCTION(IRObjectGetMetalLibBinary, irconverter)
					LINK_DLL_FUNCTION(IRMetalLibGetBytecodeSize, irconverter)
					LINK_DLL_FUNCTION(IRMetalLibGetBytecode, irconverter)
					LINK_DLL_FUNCTION(IRMetalLibBinaryDestroy, irconverter)
					LINK_DLL_FUNCTION(IRObjectDestroy, irconverter)
					LINK_DLL_FUNCTION(IRCompilerDestroy, irconverter)
					LINK_DLL_FUNCTION(IRRootSignatureCreateFromDescriptor, irconverter)
					LINK_DLL_FUNCTION(IRCompilerSetGlobalRootSignature, irconverter)
					LINK_DLL_FUNCTION(IRCompilerEnableGeometryAndTessellationEmulation, irconverter)
					//LINK_DLL_FUNCTION(IRRootSignatureDestroy, irconverter)
					...
					{
						LINK_DLL_FUNCTION(IRShaderReflectionCreate, irconverter)
						LINK_DLL_FUNCTION(IRObjectGetReflection, irconverter)
						LINK_DLL_FUNCTION(IRShaderReflectionCopyVertexInfo, irconverter)
						LINK_DLL_FUNCTION(IRShaderReflectionCopyGeometryInfo, irconverter)
						LINK_DLL_FUNCTION(IRShaderReflectionCopyComputeInfo, irconverter)
						LINK_DLL_FUNCTION(IRShaderReflectionCopyMeshInfo, irconverter)
						LINK_DLL_FUNCTION(IRShaderReflectionCopyAmplificationInfo, irconverter)
						LINK_DLL_FUNCTION(IRShaderReflectionDestroy, irconverter)
