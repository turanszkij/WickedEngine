...
std::mutex queue_locker;
	...
	{
		auto internal_state = swapchain->IsValid() ? wi::allocator::upcast_internal<SwapChain_DX12>(swapchain->internal_state) : wi::allocator::make_internal<SwapChain_DX12>();
	...
	{
		auto internal_state = wi::allocator::make_internal<Resource_DX12>();
		internal_state->allocationhandler = allocationhandler;
	...
	{
		auto internal_state = wi::allocator::make_internal<Texture_DX12>();
		internal_state->allocationhandler = allocationhandler;
	...
	{
		auto internal_state = wi::allocator::make_internal<PipelineState_DX12>();
		internal_state->allocationhandler = allocationhandler;
	...
	{
		auto internal_state = wi::allocator::make_internal<Sampler_DX12>();
		internal_state->allocationhandler = allocationhandler;
	...
	{
		auto internal_state = wi::allocator::make_internal<QueryHeap_DX12>();
		internal_state->allocationhandler = allocationhandler;
	...
	{
		auto internal_state = wi::allocator::make_internal<BVH_DX12>();
		internal_state->allocationhandler = allocationhandler;
	...
	{
		auto internal_state = wi::allocator::make_internal<RTPipelineState_DX12>();
		internal_state->allocationhandler = allocationhandler;
	...
	bool GraphicsDevice_DX12::CreateVideoDecoder(const VideoDesc* desc, VideoDecoder* video_decoder) const
	{
		...
		auto internal_state = wi::allocator::make_internal<VideoDecoder_DX12>();
		internal_state->allocationhandler = allocationhandler;
