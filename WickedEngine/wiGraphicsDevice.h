...
namespace wiGraphicsTypes
{
	...
	public:
		...
		virtual void BindResourcePS(GPUResource* resource, int slot, GRAPHICSTHREAD threadID, int arrayIndex = -1) = 0;
		virtual void BindResourceVS(GPUResource* resource, int slot, GRAPHICSTHREAD threadID, int arrayIndex = -1) = 0;
		virtual void BindResourceGS(GPUResource* resource, int slot, GRAPHICSTHREAD threadID, int arrayIndex = -1) = 0;
		virtual void BindResourceDS(GPUResource* resource, int slot, GRAPHICSTHREAD threadID, int arrayIndex = -1) = 0;
		virtual void BindResourceHS(GPUResource* resource, int slot, GRAPHICSTHREAD threadID, int arrayIndex = -1) = 0;
		virtual void BindResourceCS(GPUResource* resource, int slot, GRAPHICSTHREAD threadID, int arrayIndex = -1) = 0;
		virtual void BindResourcesPS(GPUResource *const* resources, int slot, int count, GRAPHICSTHREAD threadID) = 0;
		virtual void BindResourcesVS(GPUResource *const* resources, int slot, int count, GRAPHICSTHREAD threadID) = 0;
		virtual void BindResourcesGS(GPUResource *const* resources, int slot, int count, GRAPHICSTHREAD threadID) = 0;
		virtual void BindResourcesDS(GPUResource *const* resources, int slot, int count, GRAPHICSTHREAD threadID) = 0;
		virtual void BindResourcesHS(GPUResource *const* resources, int slot, int count, GRAPHICSTHREAD threadID) = 0;
		virtual void BindResourcesCS(GPUResource *const* resources, int slot, int count, GRAPHICSTHREAD threadID) = 0;
		...
		virtual void BindSamplerPS(Sampler* sampler, int slot, GRAPHICSTHREAD threadID) = 0;
		virtual void BindSamplerVS(Sampler* sampler, int slot, GRAPHICSTHREAD threadID) = 0;
		virtual void BindSamplerGS(Sampler* sampler, int slot, GRAPHICSTHREAD threadID) = 0;
		virtual void BindSamplerHS(Sampler* sampler, int slot, GRAPHICSTHREAD threadID) = 0;
		virtual void BindSamplerDS(Sampler* sampler, int slot, GRAPHICSTHREAD threadID) = 0;
		virtual void BindSamplerCS(Sampler* sampler, int slot, GRAPHICSTHREAD threadID) = 0;
		virtual void BindConstantBufferPS(GPUBuffer* buffer, int slot, GRAPHICSTHREAD threadID) = 0;
		virtual void BindConstantBufferVS(GPUBuffer* buffer, int slot, GRAPHICSTHREAD threadID) = 0;
		virtual void BindConstantBufferGS(GPUBuffer* buffer, int slot, GRAPHICSTHREAD threadID) = 0;
		virtual void BindConstantBufferDS(GPUBuffer* buffer, int slot, GRAPHICSTHREAD threadID) = 0;
		virtual void BindConstantBufferHS(GPUBuffer* buffer, int slot, GRAPHICSTHREAD threadID) = 0;
		virtual void BindConstantBufferCS(GPUBuffer* buffer, int slot, GRAPHICSTHREAD threadID) = 0;
