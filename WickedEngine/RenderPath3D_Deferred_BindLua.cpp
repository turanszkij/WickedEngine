...
const char RenderPath3D_Deferred_BindLua::className[] = "RenderPath3D_Deferred";

Luna<RenderPath3D_Deferred_BindLua>::FunctionType RenderPath3D_Deferred_BindLua::methods[] = {
...
Luna<RenderPath3D_Deferred_BindLua>::PropertyType RenderPath3D_Deferred_BindLua::properties[] = {
	{ NULL, NULL }
};
...
void RenderPath3D_Deferred_BindLua::Bind()
{
	...
	{
		initialized = true;
		Luna<RenderPath3D_Deferred_BindLua>::Register(wiLua::GetGlobal()->GetLuaState());
	}
}
