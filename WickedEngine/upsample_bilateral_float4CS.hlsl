...
void main(uint3 DTid : SV_DispatchThreadID)
{
	...
	const float4 lineardepth_lowres = float4(
		lineardepth_minmax.SampleLevel(sampler_point_clamp, uv00, lowres_depthchain_mip).r,
		lineardepth_minmax.SampleLevel(sampler_point_clamp, uv10, lowres_depthchain_mip).r,
		lineardepth_minmax.SampleLevel(sampler_point_clamp, uv01, lowres_depthchain_mip).r,
		lineardepth_minmax.SampleLevel(sampler_point_clamp, uv11, lowres_depthchain_mip).r
	);
