...
TYPEDBUFFER(sobolSequenceBuffer, uint, TEXSLOT_ONDEMAND1);
TYPEDBUFFER(scramblingTileBuffer, uint, TEXSLOT_ONDEMAND2);
TYPEDBUFFER(rankingTileBuffer, uint, TEXSLOT_ONDEMAND3);
