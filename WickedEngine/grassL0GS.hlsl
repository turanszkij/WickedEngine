...
)
{
	...
	genBlade(output,xViewProjection,pos+float4(0.1,-0.1,0.1,0),normal,length*0.93,1,right,color, wind);
	genBlade(output,xViewProjection,pos+float4(-0.3,-0.1,-0.1,0),normal,length*0.8,1,right,color, wind);
	genBlade(output,xViewProjection,pos+float4(0.2,-0.12,-0,0),normal,length*0.94,1,right,color, wind);
	genBlade(output,xViewProjection,pos+float4(-0.4,-0.05,-0.2,0),normal,length*0.98,1,right,color, wind);
	genBlade(output,xViewProjection,pos+float4(0.4,-0.01,0.22,0),normal,length*0.87,1,right,color, wind);*/
