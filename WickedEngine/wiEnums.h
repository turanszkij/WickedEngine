...
namespace wi::enums
{
	...
	enum SHADERTYPE
	{
		...
		CSTYPE_POSTPROCESS_SKYATMOSPHERE_RENDER,
		CSTYPE_POSTPROCESS_SKYATMOSPHERE_RENDER_CAPTURE,
		CSTYPE_POSTPROCESS_SKYATMOSPHERE_RENDER_CAPTURE_MSAA,
		CSTYPE_POSTPROCESS_SKYATMOSPHERE_TEMPORAL,
		CSTYPE_POSTPROCESS_SKYATMOSPHERE_SUN,
