...
namespace wi::enums
{
	...
	enum SHADERTYPE
	{
		...
		CSTYPE_POSTPROCESS_DEPTH_LINEAR,
		CSTYPE_POSTPROCESS_DEPTH_LINEAR_MSAA,
		...
		CSTYPE_TERRAIN_FALLBACK_UPDATE_BASECOLORMAP,
		CSTYPE_TERRAIN_FALLBACK_UPDATE_NORMALMAP,
		CSTYPE_TERRAIN_FALLBACK_UPDATE_SURFACEMAP,
		CSTYPE_TERRAIN_FALLBACK_UPDATE_EMISSIVEMAP,
