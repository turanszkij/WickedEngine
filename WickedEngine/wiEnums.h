...
namespace wi::enums
{
	...
	enum SHADERTYPE
	{
		...
		CSTYPE_VISIBILITY_RESOLVE_FAST,
		CSTYPE_VISIBILITY_RESOLVE_FAST_MSAA,
		CSTYPE_VISIBILITY_BINNING_OFFSETS,
		CSTYPE_VISIBILITY_BINNING_PLACEMENT,
		CSTYPE_VISIBILITY_SHADE,
