...
namespace wi::enums
{
	...
	enum SHADERTYPE
	{
		...
		CSTYPE_POSTPROCESS_AERIALPERSPECTIVE_CAPTURE_MSAA, // requires GraphicsDeviceCapability::SHADER_STORAGE_IMAGE_MULTISAMPLE
		...
		CSTYPE_POSTPROCESS_VOLUMETRICCLOUDS_RENDER_CAPTURE_MSAA, // requires GraphicsDeviceCapability::SHADER_STORAGE_IMAGE_MULTISAMPLE
