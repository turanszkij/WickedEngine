...
namespace wi::enums
{
	...
	enum SHADERTYPE
	{
		...
		VSTYPE_OBJECT_COMMON_WIND,
		VSTYPE_OBJECT_SIMPLE_WIND,
		VSTYPE_OBJECT_PREPASS_WIND,
		VSTYPE_OBJECT_PREPASS_ALPHATEST_WIND,
		VSTYPE_OBJECT_COMMON_TESSELLATION_WIND,
		VSTYPE_OBJECT_PREPASS_TESSELLATION_WIND,
		VSTYPE_OBJECT_PREPASS_ALPHATEST_TESSELLATION_WIND,
		VSTYPE_OBJECT_SIMPLE_TESSELLATION_WIND,
		...
		VSTYPE_SHADOW_WIND,
		VSTYPE_SHADOW_ALPHATEST_WIND,
		VSTYPE_SHADOW_TRANSPARENT_WIND,
		VSTYPE_SHADOWCUBEMAPRENDER_WIND,
		VSTYPE_SHADOWCUBEMAPRENDER_ALPHATEST_WIND,
		VSTYPE_SHADOWCUBEMAPRENDER_TRANSPARENT_WIND,
		...
		CSTYPE_POSTPROCESS_SKYATMOSPHERE_AERIALPERSPECTIVE_RENDER,
		CSTYPE_POSTPROCESS_SKYATMOSPHERE_AERIALPERSPECTIVE_RENDER_CAPTURE,
		CSTYPE_POSTPROCESS_SKYATMOSPHERE_AERIALPERSPECTIVE_RENDER_CAPTURE_MSAA,
		CSTYPE_POSTPROCESS_SKYATMOSPHERE_AERIALPERSPECTIVE_TEMPORAL,
