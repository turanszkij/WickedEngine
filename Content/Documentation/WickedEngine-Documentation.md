...
- `Format::R10G10B10A2_UNORM`, which supports both the `COLOR_SPACE_SRGB` (which is SDR) and `COLOR_SPACE_HDR10_ST2084` (HDR10) color spaces.
- `Format::R16G16B16A16_FLOAT`, which supports the `COLOR_SPACE_HDR_LINEAR` color space.
