...
void PostprocessWindow::Create(EditorComponent* editor)
{
	...
	if (wiRenderer::GetDevice()->CheckCapability(GraphicsDeviceCapability::RAYTRACING))
	{
	...
	raytracedReflectionsCheckBox.SetEnabled(wiRenderer::GetDevice()->CheckCapability(GraphicsDeviceCapability::RAYTRACING));
