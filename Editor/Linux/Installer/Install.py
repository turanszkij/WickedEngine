...
def Install():
    if(wickedRootDirectorySelected):    
        subprocess.run("sudo cp {wickedRootDirectory}/Editor/Linux/Installer/Distribution/usr/share/applications/wicked-engine.desktop /usr/share/applications/wicked-engine.desktop")
        ...
        # Please @MolassesLover on Discord or create a GitHub issue if these statements break.
